...
public class SpecificationBasedTest {
    ...
    public void testClassCompile(){
        ...
        assertThrows(RandoopException.class, ()->randoopConnector.generateRandoopTest("Esempio",5));
        try{
            randoopConnector.generateRandoopTest("Esempio",5);
    ...
    public void testDirError(){
        ...
        assertThrows(RandoopException.class, ()->randoopConnector.generateRandoopTest("Calcolatore",5));
        try{
            randoopConnector.generateRandoopTest("Calcolatore",5);
        }catch (RandoopException e){
    ...
    public void testClassNotFound(){
        ...
        assertThrows(RandoopException.class, ()->randoopConnector.generateRandoopTest("Calendario",5));
        try{
            randoopConnector.generateRandoopTest("Calendario",5);
        }catch (RandoopException e){
    ...
    public void testNoExceptions() throws RandoopException{
        randoopConnector.generateRandoopTest("VCardBean",3);
