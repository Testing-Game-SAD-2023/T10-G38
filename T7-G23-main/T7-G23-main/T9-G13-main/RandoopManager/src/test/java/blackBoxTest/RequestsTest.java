...
public class RequestsTest {
    ...
    public void testReqQueue(){
        try {
            ...
            randoopConnector.generateRandoopTest("Calcolatrice1", 1);
            randoopConnector.generateRandoopTest("Calcolatrice2", 1);
            randoopConnector.generateRandoopTest("Calcolatrice3", 1);
            randoopConnector.generateRandoopTest("Calcolatrice4", 1);
