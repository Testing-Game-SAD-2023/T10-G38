...
public class RandoopFilter {
    ...
    public RandoopFilter(String className, int maxNumLevels, String repositoryPath){
        ...
        class_file_path = repositoryPath + "/AUT"+className+"/AUT"+className+"SourceCode";
    ...
    private void checkClassName() throws RandoopException{
        ...
        if(!f.isDirectory()){
            throw new RandoopException("The directory for class " + className+" doesn't exists: " + class_file_path,RandoopException.DIR_ERROR);
        }
